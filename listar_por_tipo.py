...
def devolver_variantes(lista: list, clave_tipo: str) -> list:
    '''
    de una lista de dicc , lo que hace es listar en base a una
    clave ingresada
    recibe una lista. y una clave (ej:clave_tipo="color_ojos)
    devuelve un nueva lista , ordenada '''
...
# devolver_variantes(lista_personajes, clave_tipo="color_ojos")
